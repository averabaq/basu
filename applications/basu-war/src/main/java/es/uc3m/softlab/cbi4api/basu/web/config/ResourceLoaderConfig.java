...
public class ResourceLoaderConfig implements LoaderConfig {
    ...
    /**
     * Setup the BASU node on a given model defined in path given at arguments.
    ...
    public void setup(String model) throws LoaderConfigurationException {
        ...
        try {
            ...
            logger.error(String.format("Can't load the model configuration. Source couldn't be persisted. Details [%s]", sex), sex);
            ...
            logger.error(String.format("Can't load the model configuration. Process model couldn't be persisted. Details [%s]", mex), mex);
            throw new LoaderConfigurationException(String.format("Can't load the model configuration. Process model couldn't be persisted. Details [%s]", mex), mex);
        }
    }
    /**
     *
