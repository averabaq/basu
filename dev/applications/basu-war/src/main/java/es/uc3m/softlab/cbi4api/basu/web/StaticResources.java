 ...
 */
package es.uc3m.softlab.cbi4api.basu.web;
...
public class StaticResources {
	...
	public static final String CONFIG_RESOURCE_BUNDLE="basu";
    ...
    public static final String SERVICE_NAME_RESOURCE_LOADER_CONFIG = "/cbi4api-basu/config/service/resource-loader-config";
