...
public class ModelController implements Serializable {
	...
	public void reloadModelsTable(ActionEvent event) {
		try {	
			...
			refreshModelList();
			manager.infoMsg("modelsTableForm", "es.uc3m.softlab.cbi4api.basu.event.store.processModels.reloadModelsTable.action.success", "es.uc3m.softlab.cbi4api.basu.event.store.processModels.reloadModelsTable.action.success_detail");
