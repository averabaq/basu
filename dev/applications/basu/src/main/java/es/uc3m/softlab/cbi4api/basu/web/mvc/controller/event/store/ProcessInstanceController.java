...
public class ProcessInstanceController implements Serializable {
	...
	public void reloadInstanceTable(ActionEvent event) {
		try {	
			...
			refreshInstanceList();
			manager.infoMsg("instanceTableForm", "es.uc3m.softlab.cbi4api.basu.event.store.processInstance.reloadInstanceTable.action.success", "es.uc3m.softlab.cbi4api.basu.event.store.processInstance.reloadInstanceTable.action.success_detail");
