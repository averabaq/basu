...
import es.uc3m.softlab.cbi4api.basu.event.store.facade.ProcessMappingFacade;
...
public class ProcessMappingController implements Serializable {
	...
	public void reloadMappingsTable(ActionEvent event) {
		try {	
			...
			refreshMappingList();
			manager.infoMsg("mappingsTableForm", "es.uc3m.softlab.cbi4api.basu.event.store.processMappings.reloadMappingsTable.action.success", "es.uc3m.softlab.cbi4api.basu.event.store.processMappings.reloadMappingsTable.action.success_detail");
