...
public class StaticResources {
	...
	public static final String COMPONENT_NAME_SOURCE_DAO = "/cbi4api-basu/event-store/dao/SourceDAO";
	...
	public static final String COMPONENT_NAME_ACTIVITY_INSTANCE_DAO = "/cbi4api-basu/event-store/dao/ActivityInstanceDAO";
	
	/** Component name for event service facade */
	public static final String COMPONENT_NAME_EVENT_FACADE = "/cbi4api-basu/event-store/facade/EventFacade";
	/** Component name for source service facade */
	public static final String COMPONENT_NAME_SOURCE_FACADE = "/cbi4api-basu/event-store/facade/SourceFacade";
