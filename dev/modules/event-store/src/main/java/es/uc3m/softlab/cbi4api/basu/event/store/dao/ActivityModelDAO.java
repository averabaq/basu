...
/**
 * Data access object interface for the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityModel} 
...
public interface ActivityModelDAO {
	...
	/**
	 * Find all {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityModel} entity 
	 * objects.
	 * 
	 * @return all {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityModel} entity 
	 * objects.
	...
	/**
	 * Find the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityModel} entity 
	 * object associated to the  
	 * {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityModel#getId()} as primary key.
	 * 
	 * @param id activityModel's identifier
	 * @return {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityModel} entity 
	 * object associated.
	 * @throws IllegalArgumentException if an illegal argument error occurred.
	 */
	 ...
	 * Find the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityModel} entity 
	 * object associated to the 
	 * ({@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityModel#getModelSrcId()} and
	 *  {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityModel#getSource()}) 
	 * as unique keys.
	 * 
	 * @param activityModelId activity model identifier given at the original source.
	 * @param source activityModel's source.
	 * @return {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityModel} entity object associated.
	 * @throws IllegalArgumentException if an illegal argument error occurred.
	 */
    public ActivityModel findBySourceData(String activityModelId, Source source) throws IllegalArgumentException;	
	/**
	 * Merges and synchronizes the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityModel}
	 * entity object state with the data base.
	 * 
	 * @param activityModel {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityModel}
	...
	/**
	 * Deletes the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityModel}
	...
	/**
	 * Saves the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityModel}
