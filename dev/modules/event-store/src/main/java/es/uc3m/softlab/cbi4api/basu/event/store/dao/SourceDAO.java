...
/**
 * Data access object interface for the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Source} 
...
public interface SourceDAO {
	...
	/**
	 * Find all {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Source} entity 
	 * objects.
	 * 
	...
	/**
	 * Find the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Source} entity 
	...
	/**
	 * Merges and synchronizes the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Source}
	...
	/**
	 * Deletes the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Source}
	...
	/**
	 * Saves the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Source}
