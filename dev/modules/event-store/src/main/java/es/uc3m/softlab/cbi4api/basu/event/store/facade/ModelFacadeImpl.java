...
/**
 * Facade design pattern class implementation for the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Model} 
...
public class ModelFacadeImpl implements ModelFacade {
	...
	/**
	 * Saves and synchronizes the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Model}
	...
	/**
	 * Updates and synchronizes the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Model}
	 * entity object state with the data base.
	 * 
	 * @param model {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Model}
	...
	/**
	 * Removes and synchronizes the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Model}
	 * entity object state with the data base.
	 * 
	 * @param model {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Model}
