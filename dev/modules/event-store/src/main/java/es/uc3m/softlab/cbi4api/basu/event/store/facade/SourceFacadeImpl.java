...
import es.uc3m.softlab.cbi4api.basu.event.store.dao.SourceDAO;
...
/**
 * Facade design pattern class implementation for the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Source} 
...
public class SourceFacadeImpl implements SourceFacade {
	...
	/**
	 * Gets the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Source} entity 
	 * object associated to the  
	 * {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Source#getId()} as primary key.
	 * 
	 * @param id source's identifier
	 * @return {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Source} entity 
	 * object associated.
	 */
	...
	/**
	 * Gets all {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Source} entity 
	 * objects defined at the data base.
	 * 
	 * @return all {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Source} entity 
	 * objects defined at the data base.
	 */
	...
	/**
	 * Saves and synchronizes the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Source}
	 * entity object state with the data base.
	 * 
	 * @param source {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Source}
	...
	/**
	 * Updates and synchronizes the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Source}
	 * entity object state with the data base.
	 * 
	 * @param source {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Source}
	...
	/**
	 * Removes and synchronizes the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Source}
	 * entity object state with the data base.
	 * 
	 * @param source {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.Source}
