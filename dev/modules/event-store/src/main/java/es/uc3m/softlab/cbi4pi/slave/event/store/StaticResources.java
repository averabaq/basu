 ...
 */
package es.uc3m.softlab.cbi4pi.slave.event.store;
...
public class StaticResources {
	...
	public static final String PERSISTENCE_NAME_EVENT_STORE="cbi4pi-slave-event-store";	
	/** Sigav persistence unit name */
	public static final String PERSISTENCE_UNIT_NAME_EVENT_STORE="cbi4pi-slave-event-store";
	...
	public static final String COMPONENT_NAME_EVENT_DAO = "/cbi4pi-slave/event-store/dao/EventDAO";
	/** Component name for source data access object */
	public static final String COMPONENT_NAME_SOURCE_DAO = "/cbi4pi-slave/event-store/dao/SourceDAO";
	/** Component name for model data access object */
	public static final String COMPONENT_NAME_MODEL_DAO = "/cbi4pi-slave/event-store/dao/ModelDAO";
	/** Component name for process model data access object */
	public static final String COMPONENT_NAME_PROCESS_MODEL_DAO = "/cbi4pi-slave/event-store/dao/ProcessModelDAO";
	/** Component name for activity model data access object */
	public static final String COMPONENT_NAME_ACTIVITY_MODEL_DAO = "/cbi4pi-slave/event-store/dao/ActivityModelDAO";
	/** Component name for process instance data access object */
	public static final String COMPONENT_NAME_PROCESS_MAPPING_DAO = "/cbi4pi-slave/event-store/dao/ProcessMappingDAO";
	/** Component name for process instance data access object */
	public static final String COMPONENT_NAME_PROCESS_INSTANCE_DAO = "/cbi4pi-slave/event-store/dao/ProcessInstanceDAO";
	/** Component name for activity instance data access object */
	public static final String COMPONENT_NAME_ACTIVITY_INSTANCE_DAO = "/cbi4pi-slave/event-store/dao/ActivityInstanceDAO";
	
	/** Component name for event service facade */
	public static final String COMPONENT_NAME_EVENT_FACADE = "/cbi4pi-slave/event-store/facade/EventFacade";
	/** Component name for source service facade */
	public static final String COMPONENT_NAME_SOURCE_FACADE = "/cbi4pi-slave/event-store/facade/SourceFacade";
	/** Component name for model service facade */
	public static final String COMPONENT_NAME_MODEL_FACADE = "/cbi4pi-slave/event-store/facade/ModelFacade";
	/** Component name for process model service facade */
	public static final String COMPONENT_NAME_PROCESS_MODEL_FACADE = "/cbi4pi-slave/event-store/facade/ProcessModelFacade";
	/** Component name for activity model service facade */
	public static final String COMPONENT_NAME_ACTIVITY_MODEL_FACADE = "/cbi4pi-slave/event-store/facade/ActivityModelFacade";
	/** Component name for process instance service facade */
	public static final String COMPONENT_NAME_PROCESS_INSTANCE_FACADE = "/cbi4pi-slave/event-store/facade/ProcessInstanceFacade";
	/** Component name for activity instance service facade */
	public static final String COMPONENT_NAME_ACTIVITY_INSTANCE_FACADE = "/cbi4pi-slave/event-store/facade/ActivityInstanceFacade";
	/** Component name for process mapping service facade */
	public static final String COMPONENT_NAME_PROCESS_MAPPING_FACADE = "/cbi4pi-slave/event-store/facade/ProcessMappingFacade";
