...
/**
 * Data access object interface for the {@link es.uc3m.softlab.cbi4pi.slave.event.store.entity.ProcessModel} 
...
public interface ProcessModelDAO {
	...
	/**
	 * Find all {@link es.uc3m.softlab.cbi4pi.slave.event.store.entity.ProcessModel} entity 
	 * objects.
	 * 
	...
	/**
	 * Find the {@link es.uc3m.softlab.cbi4pi.slave.event.store.entity.ProcessModel} entity 
	...
	/**
	 * Merges and synchronizes the {@link es.uc3m.softlab.cbi4pi.slave.event.store.entity.ProcessModel}
	...
	/**
	 * Deletes the {@link es.uc3m.softlab.cbi4pi.slave.event.store.entity.ProcessModel}
	...
	/**
	 * Saves the {@link es.uc3m.softlab.cbi4pi.slave.event.store.entity.ProcessModel}
