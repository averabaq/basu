...
import es.uc3m.softlab.cbi4pi.slave.event.store.dao.ModelDAO;
...
/**
 * Facade design pattern class implementation for the {@link es.uc3m.softlab.cbi4pi.slave.event.store.entity.Model} 
