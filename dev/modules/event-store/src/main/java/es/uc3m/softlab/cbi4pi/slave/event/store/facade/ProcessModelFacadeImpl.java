...
import es.uc3m.softlab.cbi4pi.slave.event.store.dao.ProcessModelDAO;
...
/**
 * Facade design pattern class implementation for the {@link es.uc3m.softlab.cbi4pi.slave.event.store.entity.ProcessModel} 
