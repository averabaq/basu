...
import es.uc3m.softlab.cbi4pi.slave.event.store.dao.SourceDAO;
...
/**
 * Facade design pattern class implementation for the {@link es.uc3m.softlab.cbi4pi.slave.event.store.entity.Source} 
...
public class SourceFacadeImpl implements SourceFacade {
	...
	/**
	 * Gets the {@link es.uc3m.softlab.cbi4pi.slave.event.store.entity.Source} entity 
	...
	/**
	 * Gets all {@link es.uc3m.softlab.cbi4pi.slave.event.store.entity.Source} entity 
	...
	/**
	 * Saves and synchronizes the {@link es.uc3m.softlab.cbi4pi.slave.event.store.entity.Source}
	...
	/**
	 * Updates and synchronizes the {@link es.uc3m.softlab.cbi4pi.slave.event.store.entity.Source}
	 * entity object state with the data base.
	 * 
	 * @param source {@link es.uc3m.softlab.cbi4pi.slave.event.store.entity.Source}
	...
	/**
	 * Removes and synchronizes the {@link es.uc3m.softlab.cbi4pi.slave.event.store.entity.Source}
	 * entity object state with the data base.
	 * 
	 * @param source {@link es.uc3m.softlab.cbi4pi.slave.event.store.entity.Source}
