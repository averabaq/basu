...
/**
 * <p>Java class for BPAFState.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="BPAFState">
 ...
 * 
 */
@XmlType(name = "BPAFState")
@XmlEnum
public enum BPAFState {
    ...
    public static BPAFState fromValue(String v) {
        for (BPAFState c: BPAFState.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
