...
/**
 * Facade design pattern class implementation for the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityInstance} 
...
public class ActivityInstanceFacadeImpl implements ActivityInstanceFacade {
	...
	/**
	 * Gets all {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityInstance} entity 
	...
	/**
	 * Saves and synchronizes the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityInstance}
	...
	/**
	 * Updates and synchronizes the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityInstance}
	 * entity object state with the data base.
	 * 
	 * @param instance {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityInstance}
	...
	/**
	 * Removes and synchronizes the {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityInstance}
	 * entity object state with the data base.
	 * 
	 * @param instance {@link es.uc3m.softlab.cbi4api.basu.event.store.domain.ActivityInstance}
